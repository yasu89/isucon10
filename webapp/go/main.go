...
func searchChairs(c echo.Context) error {
	...
	searchQuery := "SELECT id, name, description, thumbnail, price FROM chair WHERE "
...
func searchEstates(c echo.Context) error {
	...
	searchQuery := "SELECT id, name, description, thumbnail, address, rent FROM estate WHERE "
...
func searchEstateNazotte(c echo.Context) error {
	...
	err = dbEstate.Select(&estatesInPolygon, query, b.BottomRightCorner.Latitude, b.TopLeftCorner.Latitude, b.BottomRightCorner.Longitude, b.TopLeftCorner.Longitude)
	if err == sql.ErrNoRows {
